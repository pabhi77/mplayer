...
const toggleLike = function () {
  isLiked = !isLiked;
  const likeIcon = likeBtn.querySelector(".material-symbols-rounded");
  const likeBtnContainer = likeBtn.closest('.like-btn');

  // Change the like icon based on the like status
  likeIcon.textContent = isLiked ? "favorite" : "favorite_border";

  // Toggle the 'active' class for styling
  likeBtnContainer.classList.toggle("active", isLiked);

  // Change the color to red when the like button is clicked
  likeBtnContainer.style.backgroundColor = isLiked ? "red" : "";
}
